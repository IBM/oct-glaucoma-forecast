...
# HHYU: change default to 7mm (instead of 6)
def compute_rnfl_error_base(rnfl, rnfl_pred, rnfl_dia_mm=7, disc_dia_mm=1.92, use_ma=False, quadrant=None,
                            mode='forecast'):
    """
