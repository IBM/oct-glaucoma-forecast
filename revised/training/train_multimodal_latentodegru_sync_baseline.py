...
from train_multimodal_latentodegru_pretrain_baseline import getConfig as getConfigMLODE_pretrained
    ...
    for latent_dim in latent_dims:
        for expert in experts:
            ...
            for mm in modalities_exp:
                ...
                config = Config()
                data = MultimodalTimeSeriesData(fold_seed=config.fold_seed, idx_r=idx_r)
