...
# HHYU: I set the default diameter to 7
def get_mask_rnfl(H,W, disc_dia_mm=1.92, rnfl_diam_mm=7):
    #print("get_mask_rnfl:rnfl_diam_mm=", rnfl_diam_mm)
...
# HHYU: I set default diamater to 7
def mask_rnfl(stack, channel_last=True, rnfl_diam_mm=7):
    """

    :param stack: (N, nt, H,W,1)  if channel_last=True else (N, nt, 1, H,W)   [pixel range [0,255]
    :return: masked stack and the mask
    """
    #print("mask_rnfl:rnfl_diam_mm=", rnfl_diam_mm)
