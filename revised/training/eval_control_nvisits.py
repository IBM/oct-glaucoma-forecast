...
if (__name__ == '__main__'):
    ...
    #for nv_fc, si, ti in zip([3, 3, 3], [0, 0, 0], [3, 4, 5]):
        ...
        if (dopred_rnfl):
            ...
            for q in [0, 1, 2, 3]:
                ...
                errors_all_rnfl_quads[q].append(errors_gm)
    ...
    if(dopred_rnfl):
        ...
        for q in [0, 1, 2, 3]:
            save_error(model_name='control_seg' + str(q), target_modality='rnfl', errors=errors_all_rnfl_quads[q], nv=nvisits_all,
                   exp_type=exp_type, save_dir='results_' + str(fold_seed))
