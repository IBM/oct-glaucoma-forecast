...
from train_multimodalvae_laent_exp import getConfig as getConfigMVAE
...
def getConfig(modalities_, expert_, latent_dim_):
    class MyConfig(Config):
        ...
        image_dim = 64
        vfim_dim = 32
        LOG_ROOT_DIR = 'pretrain_temp_mlode_latentexp'
        ...
        def create_model(self, load_weights=False, suffix_model_path=''):
            ...
            if (load_weights):
                ...
                latentode.load_state_dict(torch.load(model_file, map_location=device)) #torch.device('cpu')
