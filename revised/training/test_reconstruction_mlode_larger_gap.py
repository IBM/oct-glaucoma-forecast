    ...
    for ei, expert in enumerate(experts):
        ...
        for mi, mm in enumerate(modalities_exp):
            ...
            for nv_fc, si, ti in zip([3, 3, 3], [0, 0, 0], [3, 4, 5]):
                ...
                # I think suman made a mistake here. He should have saved errors[1][0]?
                ...
                for rnfl_comb_index in [0, 2]:
                    ...
                    if (mm[0] == 1): #HHYU: if input includes RNFL
                        ...
                        if (rnfl_comb_index == 0): errors_rnfl_all.append(abs_err_gm)
                        if (rnfl_comb_index == 2): errors_rnfl_all_unimodal.append(abs_err_gm)
            ...
            save_error(model_name='mlode_joint_unimodal', target_modality='rnfl', errors=errors_rnfl_all_unimodal, nv=nvisits_all,
                       exp_type=exp_type, save_dir='results_' + str(fold_seed))            
